...
export default function Footer() {
    ...
    return (
        <footer className={top}>
            <div className={`${top}mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24`}>
                <div className="text-center ">
                    <h2 className="text-3xl font-extrabold text-white sm:text-5xl">AZ-BLOG</h2>
